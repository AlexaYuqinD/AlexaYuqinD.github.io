...
var commentSchema = new mongoose.Schema({
    ...
    mentions: [mongoose.Schema.Types.ObjectId], // The IDs of the users mentioned in the comment.
});
...
var photoSchema = new mongoose.Schema({
    ...
    likes: [mongoose.Schema.Types.ObjectId], // The IDs of the users who liked this photo.
});
